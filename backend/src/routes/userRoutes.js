...
import { changePassword, resetPassword, forgotPassword, verifyUser, verifyEmail, userLoginStatus, updateUser, getUser, loginUser, registerUser, logoutUser } from '../controllers/auth/userController.js';
